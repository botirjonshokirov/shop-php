...
<body>
	...
	<div class="container">
		<div class="row">
			<?php
			$getposts = mysqli_query($con, "SELECT * FROM products WHERE available >='1' AND item ='Bolttron'  ORDER BY id DESC LIMIT 10") or die(mysqlI_error($con));
